...
class MyAdvertisedDeviceCallbacks : public BLEAdvertisedDeviceCallbacks {
  void onResult(BLEAdvertisedDevice advertisedDevice) {
    ...
    if (advertisedDevice.getAddress().toString() == "5b:84:22:11:11:11") { // адрес датчика FW
    ...
    if (advertisedDevice.getAddress().toString() == "5b:70:51:11:11:11") { // адрес датчика RW
      ...
      if (advertisedDevice.haveManufacturerData() == true) { // Передает ли транслирующее устройство данные производителя? Эти данные содержат значения давления и температуры.
        ...
        RW_pressure = (uint16_t)cManufacturerData[3]; 
